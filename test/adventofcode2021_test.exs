defmodule Adventofcode2021Test do
  ...
  test "day 14-b input" do
    output =
      Adventofcode2021.read_input("14-b")
      |> Adventofcode2021.Day14.solve_b()
      |> Adventofcode2021.write_output("14-b")
  ...
  test "day 23-a sample" do
    result =
      Adventofcode2021.read_sample("23-a")
      |> Adventofcode2021.Day23.solve_a()

    assert result == 12521
  end

  @tag timeout: :infinity
  test "day 23-a input" do
    output =
      Adventofcode2021.read_input("23-a")
      |> Adventofcode2021.Day23.solve_a()
      |> Adventofcode2021.write_output("23-a")
